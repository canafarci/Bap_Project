    ...
    for params in param_values:
        try:
            ...
            pd_epw_sens, _ = pvlib.iotools.read_epw(
                "E:\\ARCHIVE\\BAP\\uwg\\data\\sensepw2.epw")
...
data = {'indoor_temp_set_point': indoor_temp_set_point_list,
        } 
 
df = pd.DataFrame(data) 

#df.to_csv("E:\\ARCHIVE\\BAP\\uwg\\csvexport\\izmir_distubitions_3a.csv")
