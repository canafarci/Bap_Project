...
wall = Element(0.5,0.791, [0.025, xps_thickness, 0.135],  [plaster, xps, brick], 0, 296, False, 'common_brick_wall_with_xps')
roof = Element(0.5, 0.791, [0.025, mineral_wool_thickness, 0.2], [plaster, mineral_wool, concrete_slab], 0, 296, True, 'roof_concrete_slab_with_mineral_wool')
...
bldg = Building(
    floor_height=2.857198352
, int_heat_night=1, int_heat_day=1, int_heat_frad=1,
    int_heat_flat=1, infil=0.286

, vent=0.98, glazing_ratio=0.146229537
, u_value=2.583612693
,
    shgc=0.67863912

, condtype='AIR', cop=5.166267931

, coolcap=900, heateff=0.8, initial_temp=300)
