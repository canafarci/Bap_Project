...
#Y = np.loadtxt(base_path + "txtexport\\izmir_morris.txt")
                        ...
                        #_izmir_morris_9-29
np.savetxt(base_path + "txtexport\\sobol-urban_characteristics-1-6-NUMPY.txt", Y)
...
with open(base_path + 'txtexport\\sobol-urban_characteristics-1-6.txt', 'w') as f:
    for line in lines:
        f.write(line)
        f.write('\n')
        f.write('------------')
...
df.to_csv(base_path + "csvexport\\sobol-urban_characteristics-1-6.csv")