...
problem = {
    ...
    'bounds': [[0.225, 0.0558333],  # glazing_ratio
               ...
               [7.5, 0.5],  # lighting_load_density
               [25, 60]],    #occupancy_density
    
    'dists': ['norm', 'norm', 'norm', 'norm', 'unif', 
              'norm', 'norm', 'norm', 'triang', 'unif']
}
...
glazing_ratio_list.sort()
wall_u_value_list.sort()
window_u_value_list.sort()
window_sghc_list.sort()
infiltration_rate_list.sort()
chiller_cop_list.sort()
indoor_temp_set_point_list.sort()
equipment_load_density_list.sort()
lighting_load_density_list.sort()
occupancy_density_list.sort()
simulation_result_list.sort()
...
#df["glazing_ratio"].plot()
#df.plot.scatter(x="glazing_ratio", y="Iteration", alpha=0.5)
graph_data = pd.DataFrame(
    data={'glazing_ratio': glazing_ratio_list})

ax = graph_data.plot.hist(bins=50, alpha=0.5)
