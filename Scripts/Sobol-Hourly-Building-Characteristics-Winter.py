...
intermediate_epw_path = "data/simulation4h.epw"
...
df.to_csv(base_path + "\\csvexport\\sobol-hourly-5-29-bc-w-S1.csv")
...
df = pd.DataFrame(data) 
df.to_csv(base_path + "\\csvexport\\sobol-hourly-5-29-bc-w-ST.csv")
...
with open(base_path + '\\txtexport\\sobol-hourly-5-29-bc-w.txt', 'w') as f:
    for line in lines:
        f.write(line)
        f.write('\n')
        f.write('------------')
...
df = pd.DataFrame(data) 
df.to_csv(base_path + "\\csvexport\\sobol-hourly-5-29-bc-w.csv")