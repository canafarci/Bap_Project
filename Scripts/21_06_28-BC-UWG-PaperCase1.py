...
def custom_uwg():
    ...
    schdef1 = SchDef(elec=default_week, gas=default_week, light=default_week,
                     occ=default_week, cool=default_week, heat=default_week,
                     swh=default_week, q_elec=7, q_gas=3.2, q_light=16,
                     n_occ=0.03, vent=0.001 * 0.2, v_swh=0.2846, bldtype='midriseapartment',
                     builtera='new')    
    ...
    bldg = Building(
        ...
        shgc=0.3, condtype='AIR', cop=3, coolcap=41, heateff=0.8, initial_temp=300)
    ...
    model = UWG.from_param_args(
        ...
        ref_sch_vector=ref_sch_vector, month=1, day=1, sensanth=100, nday=365, dtsim=3, albroad=0.05, new_epw_name="papercase1_dt.epw")
