...
def custom_uwg():
    ...
    #15.4, 21.4, 20.6  23.3, 24.4, 26.5,  33.6, 34.3, 34.8
    ...
    model = UWG.from_param_args(
        ...
        ref_sch_vector=ref_sch_vector, month=7, day=12, sensanth=19.6, nday=1, dtsim=30, albroad=0.20, 
        new_epw_name="calibepw.epw",
...
pd_epw_sens, _ = pvlib.iotools.read_epw("E:\\ARCHIVE\\BAP\\uwg\\data\\calibepw.epw")
                
indexes =  [4611, 4612, 4613, 4616, 4617, 4618, 4623, 4624, 4625]
check_list = np.zeros([len(indexes)])

j = 0
for i in indexes:
    check_list[j] = pd_epw_sens['temp_air'].values[i]
    j+= 1
