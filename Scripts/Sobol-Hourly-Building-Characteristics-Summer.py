...
df.to_excel(base_path + "\\csvexport\\sobol-hourly-6-16-bc-s-S1.xlsx")
...
df = pd.DataFrame(data)
df.to_excel(base_path + "\\csvexport\\sobol-hourly-6-16-bc-s-ST.xslx")
