...
def custom_uwg(daytime_urban_boundary_height, nighttime_urban_boundary_height, circulation_coefficient,
               UCM_UBL_exchange_coefficient, day_heatflux_treshold, night_heatflux_treshold):
    ...
    model = UWG.from_param_args(
        ...
        maxday=day_heatflux_treshold, maxnight=night_heatflux_treshold, h_ubl1=daytime_urban_boundary_height, h_ubl2=nighttime_urban_boundary_height, h_mix=0.9,
...
problem = {
    'num_vars': 6,
    'names': ['daytime_urban_boundary_height', 'nighttime_urban_boundary_height', 'circulation_coefficient', 'UCM_UBL_exchange_coefficient', 'day_heatflux_treshold', 'night_heatflux_treshold'],
    'bounds': [[500, 1000],       #daytime_urban_boundary_height
