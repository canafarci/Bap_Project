...
def custom_uwg(glazing_ratio, wall_u_value, window_u_value, window_sghc, infiltration_rate, chiller_cop, indoor_temp_set_point, equipment_load_density,
    ...
    epw_path = "E:\\ARCHIVE\\BAP\\uwg\\data\\izmir.epw"
...
problem = {
    ...
    'names': ['glazing_ratio', 'wall_u_value', 'window_u_value', 'window_sghc', 'infiltration_rate', 'chiller_cop', 
              'indoor_temp_set_point', 'equipment_load_density', 'lighting_load_density', 'occupancy_density', 'glazing_ratio', 'wall_u_value', 'window_u_value', 'window_sghc', 'infiltration_rate', 'chiller_cop', 
    ...
    for params in param_values:
        try:
            ...
            pd_epw_sens, _ = pvlib.iotools.read_epw(
                "E:\\ARCHIVE\\BAP\\uwg\\data\\sensepw.epw")
...
df.to_csv("E:\\ARCHIVE\\BAP\\uwg\\csvexport\\izmir_uniform_3a.csv")


lines = [str(Si)]
with open('E:\\ARCHIVE\\BAP\\uwg\\txtexport\\11k_izmir_uniform_3a.txt', 'w') as f:
    for line in lines:
        f.write(line)
        f.write('\n')